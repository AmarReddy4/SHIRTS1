...
<div class="container">
  ...
  <form role="form">
    <div class="form-group">
      ...
      <input type="email" style="width:30%" class="form-control" name="email" id="email" placeholder="Enter email">
    </div>
    <div class="form-group">
      <label for="pwd">Password:</label>
      <input type="password" style="width:30%" class="form-control" name="password" id="pwd" placeholder="Enter password">
    </div>
    <div class="checkbox">
